...
- no-deprecated-api: Usage of deprecated APIs
  - Usages of deprecated APIs on `sap.ui.getCore().getConfiguration()` a.k.a. "Configuration Facade" are replaced with the corresponding recommended APIs (in JS files)
  - Usages of deprecated APIs on `sap.ui.getCore()` a.k.a. "Core Facade" are replaced with the corresponding recommended APIs (in JS files)
