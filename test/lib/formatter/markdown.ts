...
test("Default", (t) => {
	...
	const markdownResult = markdownFormatter.format(lintResults, false, "1.2.3", false);
...
test("Details", (t) => {
	...
	const markdownFormatter = new Markdown();
	const markdownResult = markdownFormatter.format(lintResults, true, "1.2.3", false);
...
test("No findings", (t) => {
	const markdownFormatter = new Markdown();
	const markdownResult = markdownFormatter.format([], true, "1.2.3", false);
