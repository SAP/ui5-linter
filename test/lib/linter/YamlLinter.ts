...
framework:
  ...
  libraries:
	...
	t.is(messages[3].ruleId, "ui5-linter-no-deprecated-api", `RuleId is correct`);
	...
	t.is(messages[4].ruleId, "ui5-linter-no-deprecated-api", `RuleId is correct`);
	...
	t.is(messages[5].ruleId, "ui5-linter-no-deprecated-api", `RuleId is correct`);
