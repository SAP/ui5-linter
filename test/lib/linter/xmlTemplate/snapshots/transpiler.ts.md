...
> map

    {
      ...
      mappings: 'AAOE,kCAAqC;AAPvC,wCAGC;gBAIC,YAAqC;IAA7B,4BAA0B;;;6BAPpC,UAGC;IAIC,OAAqC',
      names: [],
      sources: [
        'XMLHtmlSvg.view.xml',
      ],
...
> map

    {
      ...
      mappings: 'AAGC,mCAIE;AAGF,kCAAgF;AAGhF,mCAA0B;AAG1B,mCAA4B;AAb5B,kDAIE;AAEF,gCAA+E;AAN/E,0CAIE;AAPH,wCAQC;eACA,WAA+E;IAAxE,wEAAsE;;;gBAC7E,YAAgF;IAAxE,kBAAgB;IAAC,uDAAqD;;;iBAG9E,aAA0B;;;iBAG1B,aAA4B;;;6BAhB7B,UAQC;IACA,OAA+E',
      names: [],
      sources: [
        'XMLRequire.view.xml',
      ],
    ...
    [
      {
        ...
        messageDetails: 'Import the \'sap/ui/model/odata/v4/ODataUtils\' module instead. See Best Practices for Developers (https://ui5.sap.com/#/topic/28fcd55b04654977b63dacbee0552712)',
