        ...
        messages: [
          {
            column: 12,
            line: 18,
            message: 'Component implements the sap.ui.core.IAsyncContentCreation interface. The redundant "async" flag for "sap.ui5/rootView" should be removed from the component manifest',
          ...
          },
          {
            column: 16,
            line: 29,
            message: 'Component implements the sap.ui.core.IAsyncContentCreation interface. The redundant "async" flag for "sap.ui5/routing/config" should be removed from the component manifest',
            messageDetails: 'sap.ui.core.IAsyncContentCreation (https://ui5.sap.com/1.120/#/api/sap.ui.core.IAsyncContentCreation)',
            pos: 551,
            ruleId: 'ui5-linter-async-component-flags',
            severity: 1,
