    ...
    [
      {
        ...
        messages: [
          ...
          },
          {
            column: 4,
            line: 8,
            message: 'Use of deprecated property \'sap.ui.commons.FormattedTextViewControl\'',
            messageDetails: 'Deprecated since 1.38.',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
          {
            column: 16,
            line: 12,
            message: 'Use of deprecated property \'sap.f.AvatarShape\'',
            messageDetails: 'Deprecated since 1.73. Use the sap.m.AvatarShape (https://ui5.sap.com/1.120/#/api/sap.m.AvatarShape) instead.',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
          {
            column: 27,
            line: 14,
            message: 'Use of deprecated property \'sap.m.DateTimeInputType\'',
            messageDetails: 'Deprecated since 1.32.8. Instead, use dedicated <code>sap.m.DatePicker</code> and/or <code>sap.m.TimePicker</code> controls.',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
          {
          ...
          },
          {
            column: 19,
            line: 24,
            message: 'Use of deprecated property \'sap.f.Avatar\'',
            messageDetails: 'Deprecated since 1.73. Use the sap.m.Avatar (https://ui5.sap.com/1.120/#/api/sap.m.Avatar) instead.',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
          {
          ...
          },
          {
            column: 69,
            line: 28,
            message: 'Use of deprecated property \'sap.f.IllustratedMessageSize\'',
            messageDetails: 'Deprecated since 1.98. Use the sap.m.IllustratedMessageSize (https://ui5.sap.com/1.120/#/api/sap.m.IllustratedMessageSize) instead.',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
          {
          ...
          },
          {
            column: 14,
            line: 48,
            message: 'Use of deprecated property \'sap.f.DynamicPageTitleArea\'',
            messageDetails: 'Deprecated since 1.54. Consumers of the sap.f.DynamicPageTitle (https://ui5.sap.com/1.120/#/api/sap.f.DynamicPageTitle) control should now use the <code>areaShrinkRatio</code> property instead of the <code>primaryArea</code> property.',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
          {
          ...
          },
          {
            column: 30,
            line: 73,
            message: 'Use of deprecated property \'sap.f.IllustratedMessage\'',
