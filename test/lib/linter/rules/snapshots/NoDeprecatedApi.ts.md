        ...
        coverageInfo: [
          {
            ...
            column: 2,
            line: 39,
            message: 'Unable to analyze this method call because the type of identifier "storeInnerAppState" in "navigationHandler.storeInnerAppState({})"" could not be determined',
          },
        ],
        errorCount: 16,
        fatalErrorCount: 0,
