...
> AutofixResult: /GlobalsExistingDefineWithDeps_ArrowFunction.js
    ...
    `sap.ui.define(["sap/m/Button", "sap/ui/thirdparty/jquery", "sap/ui/unified/FileUploader", "sap/ui/core/library", "sap/m/library", "sap/f/library", "sap/m/Avatar", "sap/m/ComboBox"], (ButtonRenamed, jQuery, FileUploader, coreLibrary, mLibrary, fLibrary) => {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new ButtonRenamed({␊
    		text: "Hello"␊
