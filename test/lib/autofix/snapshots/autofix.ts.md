...
> AutofixResult: /GlobalsExistingDefineWithDeps_ArrowFunction.js
    ...
    `sap.ui.define([␊
    	...
    	"sap/m/Avatar",␊
    	"sap/m/ComboBox"␊
    ], (ButtonRenamed, jQuery, FileUploader, coreLibrary, mLibrary, fLibrary) => {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new ButtonRenamed({␊
    		text: "Hello"␊
...
> AutofixResult: /GlobalsExistingDefineWithDeps_FunctionExpression.js
    ...
    `const factoryFn = function(ButtonRenamed, jQuery, FileUploader, coreLibrary, mLibrary, fLibrary) {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new ButtonRenamed({␊
    		text: "Hello"␊
    ...
    ␊
    sap.ui.define(["sap/m/Button", "sap/ui/thirdparty/jquery", "sap/ui/unified/FileUploader", "sap/ui/core/library", "sap/m/library", "sap/f/library", "sap/m/Avatar", "sap/m/ComboBox"], factoryFn);␊
    `
...
> AutofixResult: /GlobalsExistingDefineWithoutDeps.js
    ...
    `sap.ui.define(["sap/ui/thirdparty/jquery", "sap/m/Button", "sap/ui/unified/FileUploader", "sap/ui/core/library", "sap/m/library"], function(jQuery, Button, FileUploader, coreLibrary, mLibrary) {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new Button({␊
    		text: "Hello"␊
...
> AutofixResult: /GlobalsExistingDefineWithoutDeps_ArrowFunction.js
    ...
    `sap.ui.define(["sap/ui/thirdparty/jquery", "sap/m/Button", "sap/ui/unified/FileUploader", "sap/ui/core/library", "sap/m/library"], (jQuery, Button, FileUploader, coreLibrary, mLibrary) => {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new Button({␊
    		text: "Hello"␊
...
> AutofixResult: /GlobalsExistingDefineWithoutDeps_FunctionExpression.js
    ...
    `const factoryFn = function (jQuery, Button, FileUploader, coreLibrary, mLibrary) {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new Button({␊
    		text: "Hello",␊
    ...
    ␊
    sap.ui.define(["sap/ui/thirdparty/jquery", "sap/m/Button", "sap/ui/unified/FileUploader", "sap/ui/core/library", "sap/m/library"], factoryFn);␊
    `
