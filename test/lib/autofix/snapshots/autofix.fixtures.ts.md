    ...
    [
      {
        coverageInfo: [
          {
            ...
            column: 12,
            line: 3,
            message: 'Unable to analyze this method call because the type of identifier "formatMessage" in "jQuery.sap.formatMessage("{0} {1} {2}", ["a", "b", "c"])"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 6,
            message: 'Unable to analyze this method call because the type of identifier "setLevel" in "jQuery.sap.log.setLevel(Log.Level.DEBUG, "mockserver")"" could not be determined',
          },
          {
            category: 1,
            column: 39,
            line: 11,
            message: 'Unable to analyze this method call because the type of identifier "startsWith" in "(oResponse || "").startsWith("something")"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 22,
            message: 'Unable to analyze this method call because the type of identifier "startsWith" in "(Device.os.name || "").toUpperCase().startsWith("win".toUpperCase())"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 22,
            message: 'Unable to analyze this method call because the type of identifier "toUpperCase" in "(Device.os.name || "").toUpperCase()"" could not be determined',
          },
        ],
        errorCount: 2,
        fatalErrorCount: 0,
        ...
        messages: [
          ...
          },
          {
            column: 2,
            line: 6,
            message: 'Use of deprecated API \'jQuery.sap.log.setLevel\'',
            messageDetails: 'Deprecated test message',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
...
> AutofixResult: /TODO.js

    `sap.ui.define(["sap/base/Log", "sap/base/strings/formatMessage"], (Log, formatMessage) => {␊
    	// TODO: Multiple non-conflicting migrations within the same line should work␊
    	Log.debug(jQuery.sap.formatMessage("{0} {1} {2}", ["a", "b", "c"]), "details", "component");␊
    ␊
    	// TODO: setLevel should be replaced here␊
    	jQuery.sap.log.setLevel(Log.Level.DEBUG, "mockserver");␊
    ␊
    ␊
    	// TODO: In this case we could know that a string is provided, so the fallback to empty string is not needed␊
    	let oResponse;␊
    	if (typeof oResponse === "string" && (oResponse || "").startsWith("something")) {␊
    ␊
    	}␊
    ␊
    	// TODO: In this case we could know that a string is provided, so the fallback to empty string is not needed␊
    ...
    ␊
    	...
    	(Device.os.name || "").toUpperCase().startsWith("win".toUpperCase());␊
    });␊
    `
