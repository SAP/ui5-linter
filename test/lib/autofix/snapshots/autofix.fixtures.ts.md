...
> AutofixResult: /coreApi/DeprecatedCoreApi.js
    ...
    ␊
    	Element.getElementById("id");␊
    ␊
    	Component.create({ name: "componentName", url: "find/my/comp/here", id: "id", settings: { "settingsKey": "..." }, component: {}, async: true }); // First argument must be an object containing async: true for autofix to be applied␊
...
> AutofixResult: /coreApi/DeprecatedCoreApiWithoutImport.js
    ...
    ␊
    	...
    	Lib.getResourceBundleFor("unknown.lib"); // Do not migrate unknown libraries␊
