...
> AutofixResult: /jQueryEnhancedModuleReplacement.js
    ...
    ␊
    	...
    	var buttonPath1 = sap.ui.require.toUrl("sap/m/Button"); // resolves to "resources/sap/m/Button.js"␊
    ...
    ␊
    	...
    	var paramsByUrl = new URL("/service?x=1&y=2&z=true", "http://dummy.local").searchParams;␊
    });␊
    `
...
> AutofixResult: /jQueryNativeReplacements.js
    ...
    ␊
    	...
    	var delayedCallId = window.setTimeout(myObject["myFunction"].bind(myObject), 1000);␊
    	var delayedCallId2 = window.setTimeout(myObject.myFunction.bind(myObject), 1000, ...["myParam1"]);␊
    	var delayedCallId3 = window.setTimeout(Array.isArray.bind(window), 1000, ...["myParam1"]);␊
    	window.clearTimeout(delayedCallId);␊
    	var intervalCallId = window.setInterval(myObject["myFunction"].bind(myObject), 1000);␊
    	var intervalCallId2 = window.setInterval(myObject.myFunction.bind(myObject), 1000, ...["myParam1"]);␊
    	var intervalCallId3 = window.setInterval(Array.isArray.bind(window), 1000, ...["myParam1"]);␊
...
> AutofixResult: /jQuerySap.js
    ...
    `sap.ui.define(["sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/base/util/isPlainObject", "sap/base/util/JSTokenizer", "sap/base/util/merge", "sap/base/util/now", "sap/base/util/ObjectPath", "sap/base/util/Properties", "sap/base/util/uid", "sap/base/util/Version",␊
     "sap/ui/core/syncStyleClass", "sap/ui/dom/containsOrEquals", "sap/ui/dom/denormalizeScrollBeginRTL", "sap/ui/dom/denormalizeScrollLeftRTL", "sap/ui/dom/getOwnerWindow", "sap/ui/dom/getScrollbarSize",␊
     "sap/ui/dom/includeScript", "sap/ui/dom/includeStylesheet", "sap/ui/dom/patch", "sap/ui/dom/units/Rem", "sap/ui/events/checkMouseEnterOrLeave", "sap/ui/events/ControlEvents", "sap/ui/events/F6Navigation",␊
     "sap/ui/events/isMouseEventDelayed", "sap/ui/events/isSpecialKey", "sap/ui/events/jquery/EventSimulation", "sap/ui/events/KeyCodes", "sap/ui/events/PseudoEvents", "sap/ui/events/TouchToMouseMapping",␊
     "sap/ui/performance/Measurement", "sap/ui/performance/trace/FESR", "sap/ui/performance/trace/Interaction", "sap/ui/performance/trace/Passport", "sap/ui/security/FrameOptions",␊
     "sap/ui/util/ActivityDetection", "sap/ui/util/Mobile", "sap/ui/util/XMLHelper"], function (assert, ResourceBundle, Log, encodeCSS, encodeJS, encodeURL, encodeURLParameters, encodeXML, URLListValidator, camelize, capitalize, escapeRegExp,␊
     formatMessage, hash, hyphenate, arrayDiff, uniqueSort, deepEqual, each, isPlainObject, JSTokenizer, merge, now, ObjectPath, Properties, uid, Version, syncStyleClass, containsOrEquals, denormalizeScrollBeginRTL,␊
     denormalizeScrollLeftRTL, getOwnerWindow, getScrollbarSize, includeScript, includeStylesheet, patch, Rem, checkMouseEnterOrLeave, ControlEvents, F6Navigation, eventsIsMouseEventDelayed, eventsIsSpecialKey,␊
     EventSimulation, KeyCodes, PseudoEvents, TouchToMouseMapping, Measurement, FESR, Interaction, Passport, FrameOptions, ActivityDetection, Mobile, XMLHelper) {␊
    ...
    ␊
    	...
    	var textUpperCase1 = capitalize("myValue", 3);␊
    	var textUpperCase2 = capitalize("myValue", 0);␊
    	var textUpperCase3 = capitalize("myValue", 0);␊
    	var textUpperCase4 = capitalize("myValue", 0);␊
    ...
    ␊
    	...
    	var sapcollapseall = PseudoEvents.sapcollapseall;␊
