...
> AutofixResult: /Configuration.js
    ...
    `sap.ui.define(["sap/ui/core/Core", "sap/ui/Configuration",], function(Core, Configuration) {␊
        ...
        coverageInfo: [
          {
            ...
            column: 2,
            line: 2,
            message: 'Unable to analyze this method call because the type of identifier "setLanguage" in "Configuration().setRTL(false).setLanguage("en")"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 2,
            message: 'Unable to analyze this method call because the type of identifier "setRTL" in "Configuration().setRTL(false)"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 2,
            message: 'Unable to analyze this method call because the type of identifier in "Configuration()"" could not be determined',
          },
        ],
        errorCount: 0,
        fatalErrorCount: 0,
