...
> AutofixResult: /jQueryEnhancedModuleReplacement.js
    ...
    `sap.ui.define(["sap/ui/thirdparty/jquery", "sap/base/util/Version", "sap/ui/Device"], async function (jQuery, Version, Device) {␊
    	...
    	var isAndroidPhone = Device.os.android && Device.system.tablet.is.android_phone;␊
    	var isAndroidTablet = Device.os.android && Device.system.tablet.is.android_tablet;␊
    	var isIPhone = Device.os.ios && Device.system.phone.is.iphone;␊
    	var isIPad = Device.os.ios && Device.system.ipad.is.ipad;␊
    ␊
    	...
    	var isAndroid = Device.os.name === "Android".Android;␊
    	var isBlueBerry = Device.os.name === "bb".bb;␊
    	var isIOS = Device.os.name === "iOS".iOS;␊
    	var isWinPhone = Device.os.name === "winphone".winphone;␊
    	var isWin = Device.os.name === "win".win;␊
    	var isLinux = Device.os.name === "linux".linux;␊
    	var isMac = Device.os.name === "mac".mac;␊
    ␊
    ...
    ␊
    	...
    	sap.ui.loader.config({paths:{"ui5.project.moduleB": { path: "/ui5/project/moduleB" }}});␊
    ␊
    	sap.ui.loader.config({paths:{"me/fancy/A": "ui5/projectA/"}});␊
    	sap.ui.loader.config({paths:{"me/fancy/B": { url: "ui5/projectB/" }}});␊
    ␊
...
> AutofixResult: /jQueryNativeReplacements.js
    ...
    ␊
    	var isStandAlone = window.navigator.standalone.is.standalone;␊
