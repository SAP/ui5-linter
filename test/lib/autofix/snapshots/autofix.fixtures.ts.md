...
> AutofixResult: /jQueryEnhancedModuleReplacement.js
    ...
    `sap.ui.define(["sap/ui/thirdparty/jquery", "sap/base/util/ObjectPath", "sap/ui/dom/units/Rem"], async function (jQuery, ObjectPath, Rem) {␊
...
> AutofixResult: /jQueryReplaceWithModule.js
    ...
    `sap.ui.define(["sap/ui/thirdparty/jquery", "sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/base/util/merge", "sap/base/util/Properties", "sap/base/util/uid", "sap/base/util/Version", "sap/ui/core/syncStyleClass", "sap/ui/dom/containsOrEquals", "sap/ui/dom/denormalizeScrollBeginRTL",␊
     "sap/ui/dom/denormalizeScrollLeftRTL", "sap/ui/dom/getOwnerWindow", "sap/ui/dom/getScrollbarSize", "sap/ui/dom/includeScript", "sap/ui/dom/includeStylesheet", "sap/ui/dom/patch",␊
     "sap/ui/security/FrameOptions"], async function (jQuery, assert, ResourceBundle, Log, encodeCSS, encodeJS, encodeURL, encodeURLParameters, encodeXML, camelize, capitalize, escapeRegExp, formatMessage,␊
     hash, hyphenate, arrayDiff, uniqueSort, deepEqual, each, JSTokenizer, merge, Properties, uid, Version, syncStyleClass, containsOrEquals, denormalizeScrollBeginRTL, denormalizeScrollLeftRTL, getOwnerWindow,␊
     getScrollbarSize, includeScript, includeStylesheet, patch, FrameOptions) {␊
