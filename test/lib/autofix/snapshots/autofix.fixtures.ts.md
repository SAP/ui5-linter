...
> AutofixResult: /GlobalsExistingDefineWithDeps_ArrowFunction.js
    ...
    `sap.ui.define([␊
    	...
    	"sap/m/Avatar",␊
    	"sap/m/ComboBox"␊
    ], (ButtonRenamed, FileUploader, coreLibrary, mLibrary) => {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new ButtonRenamed({␊
    		text: "Hello"␊
...
> AutofixResult: /GlobalsExistingDefineWithDeps_FunctionExpression.js
    ...
    `const factoryFn = function(ButtonRenamed, FileUploader, coreLibrary, mLibrary) {␊
    	const avatarDOM = jQuery("#container-todo---app--avatar-profile");␊
    	const list = sap.ui.getCore().byId("container-todo---app--todoList");␊
    	const button = new ButtonRenamed({␊
    		text: "Hello"␊
    ...
    ␊
    sap.ui.define(["sap/m/Button", "sap/ui/unified/FileUploader", "sap/ui/core/library", "sap/m/library", "sap/m/Avatar", "sap/m/ComboBox"], factoryFn);␊
    `
...
> AutofixResult: /GlobalsExistingDefineWithExistingUnusedDepsMultiple3.js
    ...
    `sap.ui.define(["sap/m/Button", "sap/m/Input", "sap/m/ComboBox"], function(Button, Input) {␊
    	"use strict";␊
    ␊
    	new Button();␊
    	new Input();␊
