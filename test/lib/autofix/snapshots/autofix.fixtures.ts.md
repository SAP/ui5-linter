...
## General: coreApi/DeprecatedCoreApi.fixed.js
        ...
        coverageInfo: [
          {
            ...
            column: 2,
            line: 13,
            message: 'Unable to analyze this method call because the type of identifier "applyTheme" in "Theming.applyTheme("themeName")"" could not be determined',
          },
        ],
        errorCount: 12,
        fatalErrorCount: 0,
        filePath: 'DeprecatedCoreApi.fixed.js',
        messages: [
          {
            column: 2,
            line: 10,
            message: 'Import of deprecated module \'sap/ui/core/tmpl/Template\'',
            messageDetails: 'Deprecated test message',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
    ...
    [
      {
        coverageInfo: [
          {
            ...
            column: 2,
            line: 13,
            message: 'Unable to analyze this method call because the type of identifier "getControlsByFieldGroupId" in "sap.ui.core.Control.getControlsByFieldGroupId("id")"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 14,
            message: 'Unable to analyze this method call because the type of identifier "getControlsByFieldGroupId" in "sap.ui.core.Control.getControlsByFieldGroupId(["id", "id2"])"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 18,
            message: 'Unable to analyze this method call because the type of identifier "create" in "sap.ui.core.Component.create({ name: "componentName", url: "find/my/comp/here", id: "id", settings: { "settingsKey": "..." }, component: {}, async: true })"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 58,
            message: 'Unable to analyze this method call because the type of identifier "load" in "sap.ui.core.Lib.load({ "name": "sap.ui.core" })"" could not be determined',
          },
          {
            category: 1,
            column: 2,
            line: 59,
            message: 'Unable to analyze this method call because the type of identifier "load" in "sap.ui.core.Lib.load({ "name": "sap.ui.core", "url": "find/my/lib/here" })"" could not be determined',
          },
        ],
        errorCount: 18,
        fatalErrorCount: 0,
        ...
        messages: [
          ...
          },
          {
            column: 2,
            line: 13,
            message: 'Access of global variable \'sap\' (sap.ui.core.Control.getControlsByFieldGroupId)',
            messageDetails: 'Do not use global variables to access UI5 modules or APIs. See Best Practices for Developers (https://ui5.sap.com/#/topic/28fcd55b04654977b63dacbee0552712)',
            ruleId: 'no-globals',
            severity: 2,
          },
          ...
          },
          {
            column: 2,
            line: 18,
            message: 'Access of global variable \'sap\' (sap.ui.core.Component.create)',
            messageDetails: 'Do not use global variables to access UI5 modules or APIs. See Best Practices for Developers (https://ui5.sap.com/#/topic/28fcd55b04654977b63dacbee0552712)',
            ruleId: 'no-globals',
            severity: 2,
          },
          ...
          },
          {
            column: 2,
            line: 58,
            message: 'Access of global variable \'sap\' (sap.ui.core.Lib.load)',
            messageDetails: 'Do not use global variables to access UI5 modules or APIs. See Best Practices for Developers (https://ui5.sap.com/#/topic/28fcd55b04654977b63dacbee0552712)',
            ruleId: 'no-globals',
            severity: 2,
          },
...
> AutofixResult: /coreApi/DeprecatedCoreApi.js
    ...
    `sap.ui.define(["sap/ui/core/Core", "sap/ui/core/Component", "sap/ui/core/Element", "sap/ui/core/EventBus", "sap/ui/core/Lib", "sap/ui/core/StaticArea", "sap/ui/core/Theming", "sap/ui/Device",], function(Core, Component, Element, EventBus, Lib, StaticArea, Theming, Device) {␊
    ...
    ␊
    	sap.ui.core.Control.getControlsByFieldGroupId("id");␊
    	sap.ui.core.Control.getControlsByFieldGroupId(["id", "id2"]);␊
    ␊
    	Element.getElementById("id");␊
    ␊
    	sap.ui.core.Component.create({ name: "componentName", url: "find/my/comp/here", id: "id", settings: { "settingsKey": "..." }, component: {}, async: true }); // First argument must be an object containing async: true for autofix to be applied␊
    ...
    ␊
    	Element.getActiveElement()?.getId();␊
    ␊
    ...
    ␊
    	sap.ui.core.Lib.load({"name":"sap.ui.core"});␊
    	sap.ui.core.Lib.load({"name":"sap.ui.core","url":"find/my/lib/here"});␊
...
## General: coreApi/DeprecatedCoreApiWithoutImport.fixed.js
    ...
    [
      {
        ...
        errorCount: 12,
        fatalErrorCount: 0,
        filePath: 'DeprecatedCoreApiWithoutImport.fixed.js',
        messages: [
          {
            column: 2,
            line: 10,
...
> AutofixResult: /coreApi/DeprecatedCoreApiWithoutImport.js
    ...
    `sap.ui.define(["sap/ui/core/Component", "sap/ui/core/Core", "sap/ui/core/Element", "sap/ui/core/EventBus", "sap/ui/core/Lib", "sap/ui/core/StaticArea", "sap/ui/core/Theming", "sap/ui/Device"], function(Component, Core, Element, EventBus, Lib, StaticArea, Theming, Device) {␊
    	Theming.setTheme("themeName");␊
