...
> AutofixResult: /jQuerySap.js
    ...
    `sap.ui.define(["sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/ui/dom/units/Rem", "sap/ui/events/checkMouseEnterOrLeave", "sap/ui/events/ControlEvents", "sap/ui/events/F6Navigation", "sap/ui/events/isSpecialKey", "sap/ui/events/jquery/EventSimulation",␊
     "sap/ui/events/KeyCodes", "sap/ui/events/PseudoEvents", "sap/ui/events/TouchToMouseMapping", "sap/ui/performance/Measurement", "sap/ui/performance/trace/FESR", "sap/ui/performance/trace/Interaction",␊
     "sap/ui/performance/trace/Passport", "sap/ui/security/FrameOptions", "sap/ui/thirdparty/jquery", "sap/ui/util/Mobile", "sap/ui/util/XMLHelper"], function (assert, ResourceBundle, Log, encodeCSS, encodeJS, encodeURL, encodeURLParameters, encodeXML, URLListValidator, camelize, capitalize, escapeRegExp,␊
     ...
     denormalizeScrollLeftRTL, getOwnerWindow, getScrollbarSize, includeScript, Rem, checkMouseEnterOrLeave, ControlEvents, F6Navigation, eventsIsSpecialKey, EventSimulation, KeyCodes, PseudoEvents,␊
     TouchToMouseMapping, Measurement, FESR, Interaction, Passport, FrameOptions, jQuery, Mobile, XMLHelper) {␊
