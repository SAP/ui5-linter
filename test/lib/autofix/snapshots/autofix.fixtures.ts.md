...
> AutofixResult: /jQueryNativeReplacements.js
    ...
    ␊
    	...
    	var newObj = structuredClone(person);␊
...
> AutofixResult: /jQuerySap.js
    ...
    `sap.ui.define(["sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/base/util/isPlainObject", "sap/base/util/JSTokenizer", "sap/base/util/merge", "sap/base/util/ObjectPath", "sap/base/util/Properties", "sap/base/util/uid", "sap/base/util/Version",␊
     ...
     formatMessage, hash, hyphenate, arrayDiff, uniqueSort, deepEqual, each, isPlainObject, JSTokenizer, merge, ObjectPath, Properties, uid, Version, syncStyleClass, containsOrEquals, denormalizeScrollBeginRTL,␊
    ...
    ␊
    	...
    	var timestampsnumber = window.performance.now;␊
