...
> AutofixResult: /configurationApi/DeprecatedConfigurationApi.js
    ...
    ␊
    	...
    	Localization(sLanguage, sSAPLogonLanguage);␊
    	Localization(sLanguage);␊
    	Localization(bRTL);␊
...
> AutofixResult: /configurationApi/DeprecatedConfigurationApiWithoutImport.js
    ...
    ␊
    	Formatting.getCalendarWeekNumbering();␊
    	Configuration.getCalendarWeekNumbering();␊
    ␊
    	Security.getFrameOptions();␊
    	Configuration.getFrameOptions();␊
    ␊
    	Localization.getLanguage();␊
    ...
    ␊
    	Localization.getSAPLogonLanguage();␊
    	Configuration.getSAPLogonLanguage();␊
    ␊
    	Security.getSecurityTokenHandlers();␊
    ...
    ␊
    	Security.setSecurityTokenHandlers([() => {console.log("*Security token handler*");}]);␊
    	Configuration.setSecurityTokenHandlers([() => {console.log("*Security token handler*");}]);␊
    ␊
    	Localization.getLanguageTag().toString();␊
    ...
    [
      {
        ...
        messages: [
          ...
          },
          {
            column: 16,
            line: 75,
            message: 'Call to deprecated function \'getLocale\' of class \'Configuration\'',
            messageDetails: 'Deprecated test message',
            ruleId: 'no-deprecated-api',
            severity: 2,
          },
