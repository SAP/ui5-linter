...
> AutofixResult: /jQueryEnhancedModuleReplacement.js
    ...
    `sap.ui.define(["sap/ui/thirdparty/jquery", "sap/base/util/ObjectPath", "sap/ui/dom/units/Rem", "sap/ui/events/TouchToMouseMapping"], async function (jQuery, ObjectPath, Rem, TouchToMouseMapping) {␊
...
> AutofixResult: /jQueryReplaceWithModule.js
    ...
    `sap.ui.define(["sap/ui/thirdparty/jquery", "sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/ui/events/checkMouseEnterOrLeave", "sap/ui/events/ControlEvents", "sap/ui/events/F6Navigation", "sap/ui/events/isMouseEventDelayed", "sap/ui/events/isSpecialKey",␊
     "sap/ui/events/jquery/EventSimulation", "sap/ui/security/FrameOptions"], async function (jQuery, assert, ResourceBundle, Log, encodeCSS, encodeJS, encodeURL, encodeURLParameters, encodeXML, camelize, capitalize, escapeRegExp, formatMessage,␊
     ...
     getScrollbarSize, includeScript, includeStylesheet, patch, checkMouseEnterOrLeave, ControlEvents, F6Navigation, eventsIsMouseEventDelayed, eventsIsSpecialKey, EventSimulation, FrameOptions) {␊
