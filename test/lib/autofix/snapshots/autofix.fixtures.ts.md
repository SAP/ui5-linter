    ...
    [
      {
        coverageInfo: [
          ...
          },
          {
            ...
            column: 2,
            line: 18,
            message: 'Unable to analyze this method call because the type of identifier "create" in "sap.ui.core.Component.create({ "name": "componentName", "url": "find/my/comp/here", "id": "id", "settingsKey": "...", "async": true })"" could not be determined',
          },
          {
            category: 1,
            column: 2,
...
> AutofixResult: /coreApi/DeprecatedCoreApi.js
    ...
    ␊
    	sap.ui.core.Component.create({"name":"componentName","url":"find/my/comp/here","id":"id","settingsKey":"...","async":true}); // First argument must be an object containing async: true for autofix to be applied␊
