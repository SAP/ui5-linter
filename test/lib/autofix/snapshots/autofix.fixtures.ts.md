...
> AutofixResult: /GlobalsCoreClass.js
        ...
        messages: [
          {
            ...
            fatal: true,
            line: undefined,
            message: 'Syntax error after applying autofix for \'/jQueryEnhancedModuleReplacement.js\': Expression expected.',
...
> AutofixResult: /jQueryNativeReplacements.js
    ...
    ␊
    	...
    	var startsWithHOrh = "Hello".toLowerCase().startsWith("h");␊
    	var endsWithY = "Hello Y".endsWith("Y");␊
    	var endsWithYOry = "Hello Y".toLowerCase().endsWith("y");␊
    ...
    [
      {
        coverageInfo: [
          ...
          },
          {
            ...
            column: 23,
            line: 80,
            message: 'Unable to analyze this method call because the type of identifier "charToUpperCase" in "jQuery.sap.charToUpperCase(xy, 1)"" could not be determined',
          },
          {
            category: 1,
            column: 34,
          ...
          },
          {
            ...
            column: 34,
            line: 209,
            message: 'Unable to analyze this method call because the type of identifier "isActive" in "ActivityDetection.isActive()"" could not be determined',
          },
        ],
        errorCount: 5,
        fatalErrorCount: 0,
...
> AutofixResult: /jQuerySap.js
    ...
    `sap.ui.define(["sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/ui/dom/includeStylesheet", "sap/ui/dom/units/Rem", "sap/ui/events/checkMouseEnterOrLeave", "sap/ui/events/ControlEvents", "sap/ui/events/F6Navigation", "sap/ui/events/isMouseEventDelayed",␊
     "sap/ui/events/isSpecialKey", "sap/ui/events/jquery/EventSimulation", "sap/ui/events/KeyCodes", "sap/ui/events/PseudoEvents", "sap/ui/events/TouchToMouseMapping", "sap/ui/performance/Measurement",␊
     "sap/ui/performance/trace/FESR", "sap/ui/performance/trace/Interaction", "sap/ui/performance/trace/Passport", "sap/ui/security/FrameOptions", "sap/ui/thirdparty/jquery", "sap/ui/util/ActivityDetection",␊
     "sap/ui/util/Mobile", "sap/ui/util/XMLHelper"], function (assert, ResourceBundle, Log, encodeCSS, encodeJS, encodeURL, encodeURLParameters, encodeXML, URLListValidator, camelize, capitalize, escapeRegExp,␊
     ...
     denormalizeScrollLeftRTL, getOwnerWindow, getScrollbarSize, includeScript, includeStylesheet, Rem, checkMouseEnterOrLeave, ControlEvents, F6Navigation, eventsIsMouseEventDelayed, eventsIsSpecialKey,␊
     EventSimulation, KeyCodes, PseudoEvents, TouchToMouseMapping, Measurement, FESR, Interaction, Passport, FrameOptions, jQuery, ActivityDetection, Mobile, XMLHelper) {␊
    ...
    ␊
    	...
    	var jQuerySapRemoveUrlWhitelist = URLListValidator.entries();␊
    jQuerySapRemoveUrlWhitelist.splice(0, 1);␊
    URLListValidator.clear();␊
    jQuerySapRemoveUrlWhitelist.forEach(({protocol, host, port, path}) => URLListValidator.add(protocol, host, port, path));␊
    ␊
    	...
    	var textUpperCase2 = capitalize(xy); // Can't be migrated␊
    	var textUpperCase2 = capitalize(someFunc()); // Can't be migrated␊
    ...
    ␊
    	...
    	var clone2 = {...{}, ...myObject};␊
    	var clone3 = merge([1, 2, 3], [6, 7, 8, 9]);␊
    	var clone4 = merge([1, undefined], [6, 7, 8, 9]);␊
    	var clone5 = merge(null, [1, null]);␊
    	var clone6 = merge(null, [1, null]);␊
    	var clone7 = merge(undefined, [undefined]);␊
    	...
    	ObjectPath.set("", "Miller", { name: { firstname: "me" } });␊
    	ObjectPath.set("", "Miller", { name: { firstname: "me" } });␊
    	var myFirstName = ObjectPath.get("name.firstname", { name: { firstname: "me" } });␊
    	var myFirstName2 = ObjectPath.get("", { name: { firstname: "me" } });␊
    	var myFirstName3 = ObjectPath.get("", { name: { firstname: "me" } });␊
    	var myFirstName4 = ObjectPath.get("", { name: { firstname: "me" } });␊
    ␊
    ...
    ␊
    	...
    	var isActivityDetectionActive = ActivityDetection.isActive();␊
    ␊
    	Mobile.init();␊
    	Mobile.setIcons({␊
...
> AutofixResult: /jQuerySapWithImport.js
    ...
    `sap.ui.define(["sap/ui/core/Element", "sap/ui/thirdparty/jquery"], function (Element, jQuery) {␊
    ...
    ␊
    	...
    	var myFancyControl = [Element.closestTo(".fancyContainer")];␊
    	var myFancyControl2 = Element.closestTo(".fancyContainer");␊
    	var myFancyControl2 = Element.closestTo(".fancyContainer", true);␊
