...
> AutofixResult: /jQueryEnhancedModuleReplacement.js
    ...
    ␊
    	...
    	var buttonPath1 = sap.ui.require.toUrl(("sap.m.Button")?.replaceAll(".", "/")) + ".js"; // resolves to "resources/sap/m/Button.js"␊
    	var buttonPath2 = sap.ui.require.toUrl(("sap.m.Button")?.replaceAll(".", "/")) + "/"; // resolves to  "resources/sap/m/Button/"␊
    	var buttonPath3 = sap.ui.require.toUrl(("sap.m.Button")?.replaceAll(".", "/")) + ""; // resolves to "resources/sap/m/Button"␊
...
> AutofixResult: /jQuerySap.js
    ...
    `sap.ui.define(["sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/ui/performance/trace/FESR", "sap/ui/performance/trace/Interaction", "sap/ui/performance/trace/Passport", "sap/ui/security/FrameOptions", "sap/ui/thirdparty/jquery", "sap/ui/util/Mobile",␊
     ...
     EventSimulation, KeyCodes, PseudoEvents, TouchToMouseMapping, Measurement, FESR, Interaction, Passport, FrameOptions, jQuery, Mobile, XMLHelper) {␊
