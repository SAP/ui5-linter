        ...
        coverageInfo: [
          {
            ...
            column: 30,
            line: 6,
            message: 'Unable to analyze this method call because the type of identifier in "fnGetService("CrossApplicationNavigation")"" could not be determined',
          },
          {
            category: 1,
            column: 31,
            line: 9,
            message: 'Unable to analyze this method call because the type of identifier "getService" in "Container.getService("CrossApplicationNavigation")"" could not be determined',
          },
        ],
        errorCount: 5,
        fatalErrorCount: 0,
...
> AutofixResult: /GlobalsConditionalAccess.js
    ...
    sap.ui.define(["sap/ushell/library", "sap/ushell/Container", "sap/ui/core/Element"], function(ushellLibrary, Container, Element) {␊
    ␊
    	var fnGetService = ushellLibrary && Container && Container.getService;␊
    	if (fnGetService) {␊
    ...
    ␊
    		...
    		const oCrossAppNavigator2 = Container.getService("CrossApplicationNavigation");␊
    	}␊
    ␊
    ...
    ␊
    	// Should not be replaced, as this is a lazy dependency␊
    	const element = Element?.getElementById?.("foo");␊
    ␊
