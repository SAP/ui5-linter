...
> AutofixResult: /jQuerySap.js
    ...
    `sap.ui.define(["sap/base/assert", "sap/base/i18n/ResourceBundle", "sap/base/Log", "sap/base/security/encodeCSS", "sap/base/security/encodeJS", "sap/base/security/encodeURL",␊
     ...
     "sap/ui/util/ActivityDetection", "sap/ui/util/Mobile", "sap/ui/util/XMLHelper"], function (assert, ResourceBundle, Log, encodeCSS, encodeJS, encodeURL, encodeURLParameters, encodeXML, URLListValidator, camelize, capitalize, escapeRegExp, formatMessage, hash, hyphenate,␊
     arrayDiff, uniqueSort, deepEqual, each, isPlainObject, JSTokenizer, merge, ObjectPath, Properties, uid, Version, syncStyleClass, containsOrEquals, denormalizeScrollBeginRTL, denormalizeScrollLeftRTL, getOwnerWindow,␊
     getScrollbarSize, includeScript, includeStylesheet, patch, Rem, checkMouseEnterOrLeave, ControlEvents, F6Navigation, eventsIsMouseEventDelayed, eventsIsSpecialKey, EventSimulation, KeyCodes, PseudoEvents,␊
     TouchToMouseMapping, Measurement, FESR, Interaction, Passport, FrameOptions, ActivityDetection, Mobile, XMLHelper) {␊
