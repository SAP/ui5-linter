...
> Snapshot 40
    ...
    `Main.controller.js:␊
    sap.ui.define(["./BaseController", "sap/m/MessageBox", "sap/base/assert", "sap/m/Button", "sap/m/library", "sap/ui/core/Core", "sap/ui/core/library", "sap/ui/unified/FileUploader",␊
     "sap/ui/core/Element"], function (BaseController, MessageBox, assert, Button, mLibrary, Core, coreLibrary, FileUploader␊
    , Element) {␊
    	"use strict";␊
    ␊
