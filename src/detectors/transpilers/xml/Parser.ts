...
import {LintMessage, LintMessageSeverity} from "../../AbstractDetector.js";
...
const log = getLogger("transpilers:xml:Parser");
...
export default class Parser {
	...
	constructor(resourceName: string, apiExtract: ApiExtract) {
