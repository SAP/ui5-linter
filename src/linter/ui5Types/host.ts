...
function addSapui5TypesMappingToCompilerOptions(
	sapui5TypesFiles: string[], options: ts.CompilerOptions, projectNamespace: string | undefined,
...
export async function createVirtualLanguageServiceHost(
	...
	addSapui5TypesMappingToCompilerOptions(
		await collectSapui5TypesFiles(), options, context.getNamespace(), libraryDependencies);
