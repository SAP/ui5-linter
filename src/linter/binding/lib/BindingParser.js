/*
 * This is a copy of the sap/ui/base/BindingParser.js module of the OpenUI5 project
 * https://github.com/SAP/openui5/blob/a4507f0d4f8a56cc881e8983479c8f9b21bfb96b/src/sap.ui.core/src/sap/ui/base/BindingParser.js
 *
 * Modifications are marked with "UI5 LINTER MODIFICATION"
 */

/* UI5 LINTER MODIFICATION: Replace sap.ui.define with ESM imports and export */
...
/* UI5 LINTER MODIFICATION:
	Disabled function "resolveBindingInfo": UI5 linter does not require a fully resolved binding info.
*/
...
function resolveEmbeddedBinding(oEnv, sInput, iStart) {
	...
	if ( rObject.test(sInput.slice(iStart)) ) {
		...
		/* UI5 LINTER MODIFICATION:
			Disabled call to resolveBindingInfo. See the comment above the function's definition for details
		*/
